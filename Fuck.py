...
def teman(nunu):
    ...
    try:
        ...
        os.system('echo "___________________________________________________________________________________" | lolcat -a -d 2 -9')
...
def publik(nunu):
    ...
    try:
        ...
        os.system('echo "____________________________________________________________________________________" | lolcat -a -d 2 -9')
        raw_input(' [%s ENTER%s ] '%(O,N));mr_error()
    except (KeyError,IOError):
        os.remove(knt)
        jalan('\n %s[%s!%s] ID DUMP FAILED, MAYBE THE ID IS NOT PUBLIC.\n'%(N,M,N))
